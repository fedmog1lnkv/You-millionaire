...
label scene_5:
    ...
    show Igor at right with dissolve
    Igor "Да…"
    Igor "это именно то что мне нужно!"
    ...
    Masha "Эх…"
    Masha "Я бы тоже хотела миллион. Моя мама лежит сейчас в больнице, одна."
    Masha "Я не знаю, что мне делать.\nМне нужны деньги."
    ...
    menu:
        ...
        "Взять деньги":
            ...
            jump scene_8
        "Отказаться":
            Vova "Спасибо, но я думаю я сам что-нибудь придумаю, не хочу влезать в долги"
...
label scene_6:
    ...
    Vova "Подумываю над стартапом"
    Vova "но не знаю даже с чего начать."
    ...
    show Vova at left with dissolve
    Vova "Жалко очень твою маму…"
    Igor "У нее действительно проблема."
    Vova "Что бы могло произойти, что бы ей было хорошо."
    ...
    menu:
        "Послушай, сейчас не спрашивай, просто возьми их."
        "Взять деньги":
